 ...
 * refer http://jayeshcp.wordpress.com/2013/07/23/showing-eula-in-android-app/.code taken from this location
 */
...
public class STWEula {
    private String EULA_PREFIX = "appeula";
    private Activity mContext;
 
    public STWEula(Activity context) {
        mContext = context;
    }
